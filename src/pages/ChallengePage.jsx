...
const ChallengePage = ({
  ...
  const todayChallengeCard = (
    <>
      ...
      {loading ? (
        <div className="mt-4 rounded-none border-4 border-black bg-[#FFD93D] p-4 text-black shadow-[4px_4px_0px_0px_#000]">
          <p className="text-[10px] font-black uppercase tracking-[0.22em]">
            Loading
          </p>
          <p className="mt-2 text-sm font-bold">Fetching challenge...</p>
        </div>
      ) : (
        <>
          {featuredChallenge ? (
  ...
  return (
    <section className="mx-auto w-full max-w-[1600px] px-4 py-6 sm:px-6 lg:px-8 lg:py-8">
      ...
      >
        ...
        {/* Center: scrollable main (DOM second so it sits between side columns on lg) */}
        <main
          className={cn(
        ...
        >
          <div className="space-y-8 pb-4 lg:space-y-10 xl:grid xl:grid-cols-[minmax(0,1fr)_min(360px,38%)] xl:items-start xl:gap-8 xl:space-y-0">
            <div className="space-y-4 xl:min-w-0">
              ...
              {loading ? (
                <div className="neo-panel border-4 border-black bg-[#C4B5FD] p-8 shadow-[4px_4px_0px_0px_#000]">
                  <p className="text-sm font-bold text-black">
                    Loading challenge list...
                  </p>
                </div>
              ) : (
        ...
        {/* Right: today&apos;s challenge sticky card */}
